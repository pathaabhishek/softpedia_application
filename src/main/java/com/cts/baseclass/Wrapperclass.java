...
public class Wrapperclass {
 ...
 FileInputStream fis;
  ...
  public void launchApp() throws IOException {
	  ...
	  fis = new FileInputStream("C:\\abhishek\\Softpedia\\src\\test\\resources\\configurationproperty\\config.property");
	    prop = new Properties();
		prop.load(fis);
  ...
  System.setProperty("webdriver.chrome.driver", "C:\\aaaa\\chromedriver.exe");
